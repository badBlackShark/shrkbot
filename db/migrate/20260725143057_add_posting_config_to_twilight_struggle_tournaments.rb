...
class AddPostingConfigToTwilightStruggleTournaments < ActiveRecord::Migration[8.1]
  def change
    ...
    add_column :twilight_struggle_tournaments, :template_win, :text
    add_column :twilight_struggle_tournaments, :template_tie, :text
    add_column :twilight_struggle_tournaments, :template_video, :text
