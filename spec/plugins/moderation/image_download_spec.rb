...
RSpec.describe Moderation::ImageDownload do
  ...
  context "when the download returns a non-success status" do
    ...
    it "raises an Ocr::Error" do
      expect { download }.to raise_error(Moderation::Ocr::Error, /404/)
    end
  end
  ...
  context "when the connection fails" do
    ...
    it "raises an Ocr::Error" do
      expect { download }.to raise_error(Moderation::Ocr::Error, "no dns")
    end
  end
end
